...
sam_file = '%s/chrs/chr15/hits.sam'%dataDir
...
condition = 'oldSgFiles_newSFlessP'
...
def gen_res():
    ...
    for cond, t in T:
        ...
        #sg_cmds.append(cmd)
        #pdb.set_trace()
        sg_dir = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/snyder_0807b/chrs/chr15/intermediate/'
