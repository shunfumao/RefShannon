...
#dataDir = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/TransCombTest/SnyderSimChr15/star/'

#alginment = '%s/hits.sam'%dataDir

cases = []
cases.append(['stringtie', '', 'stringtie_DefaultParam'])
#cases.append(['stringtie', '--maxSens -addHead', 'stringtie_f_0_c_0.001'])
