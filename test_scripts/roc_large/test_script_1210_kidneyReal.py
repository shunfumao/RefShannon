...
dataDir = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/kidney_0916a/'
...
#real kidney
chrs_dir = '/data1/shunfu1/ref_shannon_modi/data//kidney_0916a/chrs/'
...
def gen_res():
    ...
    '''resDir = '%s/%s/chrs/'%(rootResDir, T[0][0]) #refShannon_test/nomergetypeII/chrs/:target/intermediate/
    ...
    for cond, t in T:
        ...
        algoResDir = '%s/%s/%s/chrs/'%(rootResDir, cond, t) #refShannon_test/nomergetypeII/(t)/chrs/:target/algo_output
        pooledAlgoResDir = '%s/%s/%s/'%(rootResDir, cond, t) #refShannon_test/nomergetypeII/(t)/: reconstructed_all.fasta
        
        #test purpose
        #algoResDir = '%s/%s_lessP/%s/chrs/'%(rootResDir, cond, t) #refShannon_test/nomergetypeII/(t)/chrs/:target/algo_output
        #pooledAlgoResDir = '%s/%s_lessP/%s/'%(rootResDir, cond, t) #refShannon_test/nomergetypeII/(t)/: reconstructed_all.fasta
