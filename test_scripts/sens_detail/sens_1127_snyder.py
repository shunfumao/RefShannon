...
# snyder, hg19, original merge II, sf less P
#recLog = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/snyder_0807b/refShannon_test_mergeII_partial_tune_cov_approx4_trial_cov_unlimit_dump/mergeII_partial_tune_cov_approx4_trial_cov_unlimit_dump_lessP/0/reconstructed_all_log.txt'
recLog = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/snyder_0807b/refShannon_test_mergeII_approx4_SF_lessP/mergeII_approx4_SF_lessP/0/reconstructed_all_log.txt'
...
#cmpLog = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/ww_1002a/Per_Log_fpLog/reconstructed_log.txt' # ww hg9
cmpLog = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/snyder_0807b/Per_Log_fpLog/reconstructed_log.txt' #refShannon old res (before mergeII_approx4_SF_leffP)
...
#outFileStem = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/snyder_0807b/sens_refShannonOrigMergeIISFlessP_refShannon_L%d_S%d'%(L,S)
outFileStem = '/data1/shunfu1/ref_shannon_modi/data/sgRefShannon/snyder_0807b/sens_refShannonOrigMergeIIaprox4SFlessP_refShannon_L%d_S%d'%(L,S)
...
#ablist = '0,17.8,30.0,56.8,142.5,1e10'#60,10,10,10,10 percentile
ablist = '0.0,2.23,6.09,17.83,56.85,1e10' #20 percentile per group
